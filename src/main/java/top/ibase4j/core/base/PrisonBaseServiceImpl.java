 ...
 * @param <M>
 */
public class PrisonBaseServiceImpl<T extends PrisonBaseModel, M extends PrisonBaseMapper<T>>
		implements PrisonBaseService<T> {
	...
	@Override
	@Transactional
	public void del(List<String> ids, String userId) {
	...
	public Pagination<T> query(Map<String, Object> params) {
		Page<String> page = PageUtil.getPrisonPage(params);
