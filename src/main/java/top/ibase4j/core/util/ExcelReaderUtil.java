...
import top.ibase4j.core.support.file.excel.IRowReader;
...
public final class ExcelReaderUtil {
	...
	public static void main(String[]args){
		String excel = "D:\\projects\\newprison\\iBase4J-SYS-Web\\src\\main\\webapp\\WEB-INF\\upload\\3e26fa85-6d1a-4dd7-a213-5cddaf0cd68b.xls";
		try {
			IRowReader demo = null;
			ExcelReaderUtil.readExcel(demo , excel);
		} catch (Exception e) {
