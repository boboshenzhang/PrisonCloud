...
public class OracleGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUsername("punishment");
        dsc.setPassword("punishment");
        dsc.setUrl("jdbc:oracle:thin:@192.168.199.106:1521/orcl");
        ...
        // 自定义实体父类
        strategy.setSuperEntityClass("top.ibase4j.core.base.PrisonBaseModel");
        // 自定义实体，公共字段
        strategy.setSuperEntityColumns(
            new String[]{"id"});
        // 自定义 mapper 父类
        strategy.setSuperMapperClass("top.ibase4j.core.base.PrisonBaseMapper");
        // 自定义 service 父类
        
        strategy.setSuperServiceClass("top.ibase4j.core.base.PrisonBaseService");
        // 自定义 service 实现类父类
        strategy.setSuperServiceImplClass("top.ibase4j.core.base.PrisonBaseServiceImpl");
        // 自定义 controller 父类
        strategy.setSuperControllerClass("top.ibase4j.core.base.PrisonBaseController");
