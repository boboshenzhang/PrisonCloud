...
public final class LoginHelper {
	...
	/** 用户登录 */
	public static final Boolean login(int type,String account, String password, String host) {
		UsernamePasswordToken token = new UsernamePasswordToken(account, type==0?password:"shiro.sso.secretKey201808252cx", host);
