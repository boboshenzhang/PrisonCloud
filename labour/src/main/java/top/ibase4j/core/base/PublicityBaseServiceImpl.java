 ...
 * @param <M>
 */
public class PublicityBaseServiceImpl<T extends PublicityBaseModel, M extends PublicityBaseMapper<T>>
		implements PublicityBaseService<T> {
	...
	@Override
	@Transactional
	public void del(List<String> ids, Long userId) {
	...
	@Override
	@Transactional
	public void del(String id, Long userId) {
		try {
	...
	/** 根据Id查询(默认类型Map) */
	public Pagination<Map<String, Object>> getPageMap(final Page<String> ids) {
		if (ids != null) {
	...
	public Pagination<T> query(Map<String, Object> params) {
		Page<String> page = PageUtil.getPublicityPage(params);
	...
	/** 根据Id查询(默认类型T) */
	@Override
	public List<T> queryList(final List<String> ids) {
	...
	/** 根据Id查询(cls返回类型Class) */
	@Override
	public <K> List<K> queryList(final List<String> ids, final Class<K> cls) {
	...
	/** 根据Id批量查询(默认类型T) */
	protected Pagination<T> getPage(final Page<String> ids) {
		if (ids != null) {
	...
	/** 根据Id查询(cls返回类型Class) */
	private <K> Pagination<K> getPage(final Page<String> ids, final Class<K> cls) {
		if (ids != null) {
